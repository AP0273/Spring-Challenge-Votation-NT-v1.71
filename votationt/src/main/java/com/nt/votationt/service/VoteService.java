...
System.out.println("Cpfperson" + form.getCpfPerson());
		...
		if (scheduleservice.isScheduleExist(form.getIdschedule()) == false)
			throw new ResourceNotFoundExeception("Error Schedule Not Found");
		if (personservice.login(form.getCpfPerson(), form.getPassword()) == false)
		...
		if (scheduleservice.isAlreadyVoted(form) == true)
