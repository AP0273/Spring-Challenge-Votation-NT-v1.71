...
public class InsertPerson {
	...
	public void insertPersonErrorInvalidCpf() {
        ...
        assertThrows(NullPointerException.class, () -> { service.insertPerson(person, type); });
	}
	@Test
	public void insertPersonErrorAlreadyExist() {
        ...
        Mockito.when(repository.findByCpf(person.getCpf())).thenReturn(person);
  	   var exception = assertThrows(AlreadyExistException.class, () -> {service.insertPerson(person, type);});
	...
	public void insertPersonErrorInvalidPhone() {
        ...
        Mockito.when(verify.verifyPhone(person.getPhone())).thenReturn(false);
  	   var exception = assertThrows(BadRequestException.class, () -> {service.insertPerson(person, type);});
	...
	public void insertPersonErrorWeakPassword() {
        ...
        Mockito.when(verify.verifyPassword(person.getPassword())).thenReturn(false);
  	   var exception = assertThrows(BadRequestException.class, () -> {service.insertPerson(person, type);});
       assertEquals("Weak Password, should be at least 8-character long containing upper and lower case letters,numbers and symbols." , exception.getMessage());
	}
	@Test
